...
<body>
	<script>
		...
		var examCommentXML='<?xml version="1.0" encoding="UTF-8"?><rootNode><!--preComment--><preNode>preNodeText</preNode><node><child1>child1Text</child1><!--ChildComment--><child2>child2Text</child2></node><nextNode>nextNodeText</nextNode><!--nextComment--></rootNode>';
	</script>
	...
	<input type="button" name="commentAlert" value="commentAlert" onclick='xml.commentAlert(examCommentXML)'>
</body>
</html>